...
(defn- resolve-joined-tables* [{{source-table-id :source-table} :query, :as query}]
  (let [fk-clauses (filter both-args-are-field-id-clauses? (mbql.u/clause-instances :fk-> (:query query)))]
